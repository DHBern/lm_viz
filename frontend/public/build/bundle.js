...
var app = (function () {
    ...
    function create_each_block(key_1, ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*point*/ ctx[12].Label + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*point*/ ctx[12].Legend + "";
    	let t2;
    	let t3;
    	let mounted;
    	let dispose;
    	...
    	function mouseenter_handler() {
    		return /*mouseenter_handler*/ ctx[5](/*point*/ ctx[12]);
    	}

    	function mouseleave_handler() {
    		return /*mouseleave_handler*/ ctx[6](/*point*/ ctx[12]);
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const get_key = ctx => /*point*/ ctx[12].Label;
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*data, selectedItem, selectPoint, deselectPoint*/ 26) {
    				each_value = data;
    				validate_each_argument(each_value);
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const mouseenter_handler = point => selectPoint(point.Label);
    	const mouseleave_handler = point => deselectPoint(point.Label);
